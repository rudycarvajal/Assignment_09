...
# Rcarvajal, 2020-Sep-13, added code to save inventory and load inventory methods
#------------------------------------------#
...
class FileIO:
    ...
    def save_inventory(file_name: list, lst_Inventory: list) -> None:
        """Saves the list of inventory files as text files
    ...
    def load_inventory(file_name: list) -> list:
        """Loads inventory from file to store in working memory
